defmodule VendingMachineWeb.UserControllerTest do
  ...
  @create_attrs %{username: "some username", password: "some password", role: "some role", deposit: 42}
  @update_attrs %{username: "some updated username", password: "some updated password", role: "some updated role", deposit: 43}
  @invalid_attrs %{username: nil, password: nil, role: nil, deposit: nil}
